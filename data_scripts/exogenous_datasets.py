...
class ExogenousDataset:
    ...
    def read_all_exogenous_data(self):
        ...
        all_exog_data[self.date_col] = all_exog_data[self.date_col].apply(lambda x: datetime.datetime.strptime(x,"%Y-%m-%d"))
    ...
    def get_feature_columns(self):
        ...
        for col in self.feature_cols:
            ...
            cols.extend(list(filter(lambda x: (x[:-2].endswith(col)) and # removes '-#' and checks if it ends with col
